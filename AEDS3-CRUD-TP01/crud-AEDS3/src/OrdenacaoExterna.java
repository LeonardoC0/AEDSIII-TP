...
public class OrdenacaoExterna {
    final static String nomeArquivo = "AEDS3-CRUD-TP01/crud-AEDS3/dados/conta.db";
    final static String prefixo = ".db";
    final static int ramSize = 4;
    static long ptrControl = 4;
    public static void main(String[] args) {
        dist(5, 2);
        listAccouts("AEDS3-CRUD-TP01/crud-AEDS3/dados/tmp0.db");
        System.out.println("---------------");
        listAccouts("AEDS3-CRUD-TP01/crud-AEDS3/dados/tmp1.db");
    }
