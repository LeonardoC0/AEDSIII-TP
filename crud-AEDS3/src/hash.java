...
public class hash {
    ...
    public static void criaHash(RandomAccessFile arq, long comeco) { // cria o arquivo de hash inicial
		...
		try {
			...
			// abre o arquivo de indice hash
			RandomAccessFile arqHash = new RandomAccessFile("AEDSIII-TP/AEDS3-CRUD-TP01/crud-AEDS3/dados/hash.db", "rw");
			
			// limpa o arquivo de indice hash
			arqHash.setLength(0);
			
			// abre o arquivo de diretorio
			RandomAccessFile arqDir = new RandomAccessFile("AEDSIII-TP/AEDS3-CRUD-TP01/crud-AEDS3/dados/diretorio.db", "rw");
